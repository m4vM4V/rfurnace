...
#endif
  "",
  _N("help also Furnace grow:"),
  "https://github.com/tildearrow/furnace",
  "",
  _N("contact filippp | discord:"),
  "*znakizodiakulol*",
  "",
  _N("disclaimer:"),
...
void FurnaceGUI::drawAbout() {
  // do stuff
  if (ImGui::Begin("About RFurnace",NULL,ImGuiWindowFlags_Modal|ImGuiWindowFlags_NoMove|ImGuiWindowFlags_NoResize|ImGuiWindowFlags_NoDocking|ImGuiWindowFlags_NoTitleBar,_("About Furnace"))) {
