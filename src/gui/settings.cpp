...
void FurnaceGUI::applyUISettings(bool updateFonts) {
  ...
  newFilePicker->registerType(".rfu", uiColors[GUI_COLOR_FILE_SONG_NATIVE], ICON_FA_FILE);
  ...
  newFilePicker->registerType(".rfi", uiColors[GUI_COLOR_FILE_INSTR], ICON_FA_FILE);
  ...
  newFilePicker->registerType(".rfw", uiColors[GUI_COLOR_FILE_WAVE], ICON_FA_FILE);
